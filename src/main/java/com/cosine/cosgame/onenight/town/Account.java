...
public class Account {
	...
	public boolean isVisitedOnenight() {
		return visitedOnenight;
	}
	public void setVisitedOnenight(boolean visitedOnenight) {
		this.visitedOnenight = visitedOnenight;
	}
	...
	public void getFromDB(String username) {
		...
		if (userDoc.get("onenight") == null) {
			name = username;
			Document doc = toDocument();
			dbutil.update("username", username, "onenight", doc);
		} else {
			Document doc = (Document) userDoc.get("onenight");
			setFromDoc(doc);
		}
	}
	...
	public Document toDocument() {
		...
		doc.append("visitedOnenight", visitedOnenight);
	...
	public void setFromDoc(Document doc) {
		...
		visitedOnenight = doc.getBoolean("visitedOnenight", false);
	...
	public AccountEntity toAccountEntity() {
		...
		entity.setKey(key);
		entity.setVisitedBelltower(visitedOnenight);
