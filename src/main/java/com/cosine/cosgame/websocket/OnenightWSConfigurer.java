...
@Configuration
@EnableWebSocket
public class OnenightWSConfigurer implements WebSocketConfigurer {
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		registry.addHandler(new AllBoardsWSHandler(), "/onenight/allboardsrefresh").setAllowedOrigins("*");
		registry.addHandler(new boardWSHandler(), "/onenight/boardrefresh").setAllowedOrigins("*");
	}
