...
@Configuration
@EnableWebSocket
public class ThreechaodomsWSConfigurer implements WebSocketConfigurer {
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		registry.addHandler(new AllBoardsWSHandler(), "/threechaodoms/allboardsrefresh").setAllowedOrigins("*");
		registry.addHandler(new boardWSHandler(), "/threechaodoms/boardrefresh").setAllowedOrigins("*");
	}
