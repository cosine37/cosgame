...
@Configuration
@EnableWebSocket
public class PokewhatWSConfigurer implements WebSocketConfigurer {
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		registry.addHandler(new AllBoardsWSHandler(), "/pokewhat/allboardsrefresh").setAllowedOrigins("*");
		registry.addHandler(new boardWSHandler(), "/pokewhat/boardrefresh").setAllowedOrigins("*");
	}
