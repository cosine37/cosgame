...
@Configuration
@EnableWebSocket
public class BelltowerWSConfigurer implements WebSocketConfigurer {
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		registry.addHandler(new AllBoardsWSHandler(), "/belltower/allboardsrefresh").setAllowedOrigins("*");
		registry.addHandler(new boardWSHandler(), "/belltower/boardrefresh").setAllowedOrigins("*");
	}
