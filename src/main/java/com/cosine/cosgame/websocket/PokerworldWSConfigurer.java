...
@Configuration
@EnableWebSocket
public class PokerworldWSConfigurer implements WebSocketConfigurer {
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		registry.addHandler(new AllBoardsWSHandler(), "/pokerworld/allboardsrefresh").setAllowedOrigins("*");
		registry.addHandler(new boardWSHandler(), "/pokerworld/boardrefresh").setAllowedOrigins("*");
	}
