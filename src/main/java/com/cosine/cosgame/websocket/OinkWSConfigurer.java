...
@Configuration
@EnableWebSocket
public class OinkWSConfigurer implements WebSocketConfigurer {
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		registry.addHandler(new AllBoardsWSHandler(), "/oink/allboardsrefresh").setAllowedOrigins("*");
		registry.addHandler(new boardWSHandler(), "/oink/boardrefresh").setAllowedOrigins("*");
	}
