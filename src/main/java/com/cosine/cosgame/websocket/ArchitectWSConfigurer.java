...
@Configuration
@EnableWebSocket
public class ArchitectWSConfigurer implements WebSocketConfigurer {
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		registry.addHandler(new AllBoardsWSHandler(), "/architect/allboardsrefresh").setAllowedOrigins("*");
		registry.addHandler(new boardWSHandler(), "/architect/boardrefresh").setAllowedOrigins("*");
	}
