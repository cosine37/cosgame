...
@Configuration
@EnableWebSocket
public class PropnightWSConfigurer implements WebSocketConfigurer {
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		registry.addHandler(new AllBoardsWSHandler(), "/propnight/allboardsrefresh").setAllowedOrigins("*");
		registry.addHandler(new boardWSHandler(), "/propnight/boardrefresh").setAllowedOrigins("*");
	}
