...
@Configuration
@EnableWebSocket
public class GardenwarWSConfigurer implements WebSocketConfigurer {
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		registry.addHandler(new AllBoardsWSHandler(), "/gardenwar/allboardsrefresh").setAllowedOrigins("*");
		registry.addHandler(new boardWSHandler(), "/gardenwar/boardrefresh").setAllowedOrigins("*");
	}
