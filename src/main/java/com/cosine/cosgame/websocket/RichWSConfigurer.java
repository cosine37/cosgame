...
@Configuration
@EnableWebSocket
public class RichWSConfigurer implements WebSocketConfigurer {
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		registry.addHandler(new AllBoardsWSHandler(), "/rich/allboardsrefresh").setAllowedOrigins("*");
		registry.addHandler(new boardWSHandler(), "/rich/boardrefresh").setAllowedOrigins("*");
	}
