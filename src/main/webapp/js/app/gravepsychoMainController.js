...
app.controller("gravepsychoMainCtrl", ['$scope', '$window', '$http', '$document', '$timeout', '$websocket',
	function($scope, $window, $http, $document, $timeout, $websocket){
		...
		var ws = $websocket("wss://" + $window.location.host + "/gravepsycho/allboardsrefresh");
		...
		var boardws = $websocket("wss://" + $window.location.host + "/gravepsycho/boardrefresh");
		...
		$scope.getAllBoards = function(){
			$http.get('/gravepsycho/allboards').then(function(response){
