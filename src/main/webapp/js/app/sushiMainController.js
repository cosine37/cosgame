...
var app = angular.module("sushiMainApp", []);
app.controller("sushiMainCtrl", ['$scope', '$window', '$http', '$document', '$timeout',
	function($scope, $window, $http, $document, $timeout){
		...
		*/
		...
		$scope.newGame = function(){
			$scope.goto('sushicreategame');
			/*
			$http.post('/sushi/newboard').then(function(response){
				$scope.goto('sushicreategame');
			});
			*/
		}
